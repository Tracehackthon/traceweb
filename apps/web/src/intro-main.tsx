...
const formFactors = [
  { key: 'pet', index: '01', name: '悬浮入口', verb: '随时找到', help: '安静待在桌面边缘。只有一点想法时，不必离开眼前的网页或工作。', proof: '刘看山桌宠', image: '/evidence/overlay-quiet-crop.webp' },
  { key: 'input', index: '02', name: '极简输入', verb: '先接住', help: '直接说一句、带来一段原文。无需先分类、命名或整理成结论。', proof: '一句话输入', image: '/evidence/overlay-input-crop.webp' },
  { key: 'bubble', index: '03', name: '小浮窗与气泡', verb: '轻轻接着', help: '承接短讨论、纠正和暂停。收起后留下停点，而不是增加一项待办。', proof: '保存后的停点', image: '/evidence/overlay-receipt-crop.webp' },
  { key: 'matter', index: '04', name: '一件事展开', verb: '深入弄清', help: '需要讨论、找对照或自己写时，再围绕同一件事展开。', proof: '一件事界面', image: '/evidence/trace-matter.webp' },
  { key: 'desktop', index: '05', name: '完整桌面端', verb: '长期继续', help: '跨时间找回、比较和修订多件仍在变化的事，而不是增加一个聊天窗口。', proof: '跨时间回看与修订', image: '/evidence/trace-understanding-v1.webp' },
] as const;
...
const thinkingStages = [
  { key: 'source', tab: '在知乎停住', kicker: '保留原现场', title: '先保留原文，也保留你为什么停下来。', body: '链接、作者、原文片段和你当时的一句话分别保留，以后回来时仍能看见来处。', image: '/evidence/zhihu-passage.webp', proof: '知乎阅读片段' },
  { key: 'discuss', tab: '从这里接着', kicker: '回到具体停点', title: '从没想清楚的地方继续，而不是重新概括全文。', body: '讨论会从你停下的位置开始；你可以继续追问，也可以纠正、暂停或换个方向。', image: '/evidence/trace-matter.webp', proof: '一件事界面' },
  ...
  { key: 'understanding', tab: '写成我的理解', kicker: '由你确认', title: 'Agent 可以提供解释，但不能替你下结论。', body: '你可以自己写、限定范围、保留矛盾；每次修改都有来处，旧版本也仍然可查。', image: '/evidence/trace-understanding-v1.webp', proof: '我的理解界面' },
] as const;
...
const workStages = [
  { key: 'handoff', label: '带入', title: '先确认带到哪里、这次准备怎样用。', body: '项目、任务和内容范围清楚以后，只带当前真正相关的一点。带入工作不等于采用为结论。', image: '/evidence/trace-handoff.webp' },
  ...
  { key: 'return', label: '回来', title: '先看发生了什么，再决定是否改变原来的理解。', body: 'Agent 带回事实、解释和未确认的部分。你确认之后，它才会影响这件事接下来怎样继续。', image: '/evidence/trace-returned.webp' },
...
function IntroApp() {
  ...
  return <><a className="intro-skip" href="#main">跳到正文</a><header className="intro-header"><a className="intro-brand" href="#main" aria-label="Trace 产品介绍首页"><span>t.</span><b>Trace</b></a><nav aria-label="页面导航"><a href="#shape">如何展开</a><a href="#principles">为什么这样做</a><a href="#thinking">知乎与思考</a><a href="#work">进入工作</a><a href="/video">视频</a></nav><a className="header-action" href="/app/demo">体验完整演示 <Icon name="arrow" size={16}/></a></header>
  <main id="main"><section className="intro-hero" aria-labelledby="opening-title"><div className="hero-copy"><h1 id="opening-title">让值得思考的想法，<em>继续发生。</em></h1><p className="hero-lead">Trace 接住阅读、讨论和工作中还没想完的一点。你可以结合知乎公开内容继续判断，把需要实践的部分带进 Codex，再让结果回到原来的问题。</p><div className="hero-actions"><a className="primary-action" href="/app/demo">体验完整演示 <Icon name="arrow"/></a><a href="#shape">先看它怎样展开 <Icon name="down" size={16}/></a></div><div className="hero-claims"><span><Icon name="local" size={17}/><b>本地优先</b>内容先留在你的设备</span><span><Icon name="code" size={17}/><b>继续用 Codex</b>不另造一套 Agent</span></div></div><ContinuityMap/></section>
  ...
  <section className="work-section" id="work" aria-labelledby="work-title"><div className="section-heading"><p>想清楚以后，不必再手工复制粘贴</p><h2 id="work-title">不把你带回 Trace。<br/>把这段理解带进<span>正在发生的工作。</span></h2><div>把当前理解带进 Codex，继续完成原来的工作；结果回来以后，再由你决定是否修改长期理解。</div></div><WorkLoop/></section>
  ...
  <footer className="intro-footer"><a className="intro-brand" href="#main"><span>t.</span><b>Trace</b></a><p>把想过的、做过的，继续接起来。</p><nav><a href="/app/demo">完整演示</a><a href="/video">视频</a><a href={repository}>GitHub</a></nav></footer></>;
}
