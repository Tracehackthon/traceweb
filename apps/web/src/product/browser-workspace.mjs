...
// Demo records are disposable fixtures, not user content. Change this
// generation whenever the fixture shape changes so a stale demo can never
// block first paint; the personal workspace keeps its stable database name.
const DATABASE = DEMO_WORKSPACE ? 'trace-web-complete-demo-v4' : 'trace-portal-workspace-v1';
