...
function VideoPage() {
  ...
  return <main className="video-shell">
    <header><a href="/" className="video-brand"><img src="/brand/trace-app-icon-64.png" width="36" height="36" alt="" aria-hidden="true"/>Trace</a><nav><a href="/">产品介绍</a><a href="/app/demo">完整演示</a><a href="/app">我的空间</a></nav></header>
    <section className="video-stage" aria-labelledby="video-title">
      <div className="video-copy"><h1 id="video-title">从桌宠接住现场，<br/>到结果<span>回来。</span></h1><p>这段演示记录了完整的一次接续：桌宠接住一句还没想清楚的话，结合知乎公开内容继续讨论，再交给本机 Agent 实践，最后把结果带回原来的问题。视频里以 Codex 为例，Trace 也支持 Codex Harness 与已配置的自定义 Agent。</p></div>
