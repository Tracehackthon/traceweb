...
const requiredApiSurface = {
  ...
  agent: ['/api/agent/capabilities', '/api/agent/check', '/api/agent/runs', '/api/agent/runs/:id', '/api/agent/runs/:id/events', '/api/agent/runs/:id/cancel', '/api/agent/runs/:id/adoption', '/api/agent/runs/:id/approval', '/api/agent/runs/:id/input', '/api/agent/sensemaking/health', '/api/agent/sensemaking/drain'],
